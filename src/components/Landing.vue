      ...
      <v-expansion-panel expand>
        <v-expansion-panel-content v-for="hero in heroes">
          <v-layout slot="header" align-center align-content-start row>
            ...
            <v-flex>
              <v-icon color="green darken-1">mdi-sword-cross</v-icon>
              <h2>{{hero.combat}}</h2>
              <h2> {{hero.melee}}</h2>
            </v-flex>
            <v-flex>
            ...
            <v-flex>
              <v-layout row align-center align-content-start>
                <v-icon color="brown lighten-2">mdi-treasure-chest</v-icon>
                <h2>{{hero.money}}</h2>
                <v-btn flat icon @click.native.stop="hero.money = adjAttr(hero.money,5)">
                  <v-icon color="brown lighten-1">mdi-plus</v-icon>
                </v-btn>
                <v-btn flat icon @click.native.stop="hero.money = adjAttr(hero.money,50)">
                  <v-icon color="brown lighten-1">mdi-arrow-up-bold</v-icon>
                </v-btn>
                <v-btn flat icon @click.native.stop="hero.money = adjAttr(hero.money,-5)">
                  <v-icon color="brown darken-1">mdi-minus</v-icon>
                </v-btn>
                <v-btn flat icon @click.native.stop="hero.money = adjAttr(hero.money,-50)">
                  <v-icon color="brown darken-1">mdi-arrow-down-bold</v-icon>
                </v-btn>
              </v-layout>
              <v-layout row align-center align-content-start>
